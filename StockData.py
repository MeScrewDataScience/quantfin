...
class StockData():
    ...
    def dwl_data(self, ticker_col=None, excluded_rows=[], excluded_cols=[], get_link_from_cols=[], save_folder_directory=None):
        ...
        links = self._construct_tabulator_data(excluded_rows, excluded_cols, get_link_from_cols)
    ...
    def get_live_snapshot(self, excluded_rows=[], excluded_cols=[], result_column_names=[]):
        ...
        df = self._construct_tabulator_data(excluded_rows, excluded_cols, get_link_from_cols=[])
    ...
    def _construct_tabulator_data(self, excluded_rows, excluded_cols, get_link_from_cols):
        ...
        if not self.multi_pages:
            ...
            tabulator_data = self._get_data_from_table(
